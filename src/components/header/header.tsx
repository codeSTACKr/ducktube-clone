...
export const Header = ({ className }: HeaderProps) => {
    return <header className={styles['App-header']}>
                ...
                <div className={styles['flex-group']}>
                    <button className={`${styles.btn} ${styles['btn-no-bg']}`}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <button className={`${styles.btn} ${styles['btn-no-bg']} ${styles['flex-group']}`}>
                        <img src="https://github.com/codestackr.png" width="32" /></button>
                </div></header>;
};
